				 ...
				 <table id="userList" class="table table-bordered table-hover">
					 <thead>
						<tr>
							...
							<th> <?php echo $this->lang->line('from_to'); ?> </th>
...
<script type="text/javascript">
	var postListingUrl =  BASEURL+"admin/transactions/transactionajaxlist<?php echo $userId;?>";
	$('#userList').dataTable({
		"bPaginate": true,
		"bLengthChange": true,
		"bFilter": true,
	    ...
	    "columnDefs": [ { "targets": 0, "bSortable": true,"orderable": true, "visible": true } ],
	          'aoColumnDefs': [{'bSortable': false,'aTargets': [0,2,4,6,7]}],
	});
</script>
