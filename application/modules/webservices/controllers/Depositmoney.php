    ...
    { 
		...
		else
		{
			...
			else
			{
		       ...
		       $arg['data'][]  = array('url' => site_url()."paymentserver/example/www/deposit.php?enduserid=".$mobile_no."&auth=".$auth_token."&appv=".$appv."&timezone=".$timezone."&lan=".$lan."&dev=".$device_type."&fcmt=".$fcmt."&email=".$email);
    ...
    public function withdrawMoneyUsingNetBanking_get()
    {
		...
		else
		{
			...
			else
			{
                ...
                $arg['data'][]  = array('url' => site_url()."paymentserver/example/www/withdraw.php?enduserid=".$mobile_no."&auth=".$auth_token."&appv=".$appv."&timezone=".$timezone."&lan=".$lan."&dev=".$device_type."&fcmt=".$fcmt."&email=".$email);
