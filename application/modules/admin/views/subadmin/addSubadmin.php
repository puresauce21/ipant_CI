				...
				<?php 
				 ...
				 <div class="col-md-6"> 
						<div class="form-group">
						  ...
						  <input type="text" <?php echo $mobileDisable; ?> class="form-control check_no" id="exampleInputEmail1" placeholder="<?php echo $this->lang->line('mobile'); ?>" name="mobile" value="<?php echo (isset($subadminDetails->mobile_no)) ? $subadminDetails->mobile_no : ""; ?>" data-parsley-required-message="<?php echo $this->lang->line('mobile_number_required'); ?>" maxlength="25" required="">
						</div>
					</div>
				</div>
				<div class="row no-margin">
