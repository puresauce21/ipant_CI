        ...
        <div class="col-xs-12">
          <div class="box">
          	...
          	<div class="box-header clearfix">
				...
				<?php if($faq_add==1){ ?>
                  <a href="<?php echo base_url('admin/settings/addFaq'); ?>" class="btn btn add-btn btn-block btn-info deleteaction1"> <?php echo $this->lang->line('add'); ?></a>
                <?php }else{ ?>
...
<script type="text/javascript">
	var postListingUrl =  BASEURL+"admin/settings/faqajaxlist";
	$('#userList').dataTable({
		"bPaginate": true,
		"bLengthChange": true,
		"bFilter": true,
