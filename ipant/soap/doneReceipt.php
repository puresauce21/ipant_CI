		...
		if(!$soapparam) { // isAlive define if soapparam is null
			if(!$postData){
				$params = '<?xml version="1.0" encoding="UTF-8"?>
						<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:c14n="http://www.w3.org/2001/10/xml-exc-c14n#" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:saml1="urn:oasis:names:tc:SAML:1.0:assertion" xmlns:saml2="urn:oasis:names:tc:SAML:2.0:assertion" xmlns:wsu="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd" xmlns:xenc="http://www.w3.org/2001/04/xmlenc#" xmlns:wsc="http://docs.oasis-open.org/ws-sx/ws-secureconversation/200512" xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" xmlns:ns3="http://schemas.datacontract.org/2004/07/System" xmlns:ns2="http://schemas.microsoft.com/2003/10/Serialization/" xmlns:ns1="http://www.returpack.se/WebServices/ClearingService" xmlns:ns4="http://ws.returpack.kul.sp247.net/" xmlns:ns5="http://deposit.rvm.pantgateway.returpack.com/" xmlns:ns6="http://configuration.rvm.pantgateway.returpack.com/" xmlns:ns7="http://www.envipco.com/wsdl/depositService.wsdl"><SOAP-ENV:Body><ns7:DoneReceipt><ident>
						        <user>'.$user.'</user>
						  ...
						  <UUID>{'.$UUID.'}</UUID>
						  </ns7:DoneReceipt></SOAP-ENV:Body></SOAP-ENV:Envelope>';
			} else {
				$params = $postData;
			}
